...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "data_range" -parent ${Page_0}
...
proc update_PARAM_VALUE.data_range { PARAM_VALUE.data_range } {
	# Procedure called to update data_range when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.data_range { PARAM_VALUE.data_range } {
	# Procedure called to validate data_range
	return true
}
...
proc update_MODELPARAM_VALUE.data_range { MODELPARAM_VALUE.data_range PARAM_VALUE.data_range } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.data_range}] ${MODELPARAM_VALUE.data_range}
}
